/-
  ...
  Generated by `rust/compute-certificate` with `n=20736 d=12 seed=42 scale=2^30`.

  Regenerate data: `cd rust/compute-certificate && cargo run --release -- 20736 12 42 30 ../../data/20736`
