/-
  ...
  Small test graph for fast iteration. Generated by `scripts/compute-certificate`
  with `n=16 d=4 seed=42 scale=2^30`.

  Regenerate data: `cargo run --release -p compute-certificate -- 16 4 42 30 data/16`
-/
