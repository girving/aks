/-
  ...
  Foundational theory of comparator networks for sorting.

  Main results:
  • `zero_one_principle` : Networks sort all inputs iff they sort Boolean inputs.
  • Monotonicity preservation theorems for comparators and networks.
-/
