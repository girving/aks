/-
  Test: new checkCertificate (involution + PSD + columnNormBound) via native_decide.
-/
...
-- n=16
theorem cert16 : checkCertificate rotData16t certData16t 16 4 216 9 1 = true := by
  native_decide

-- n=1728
theorem cert1728 : checkCertificate rotData1728t certData1728t 1728 12 792 9 2 = true := by
  native_decide
