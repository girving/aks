...
`IsEpsilonHalver`, `tanner_bound`, `expander_gives_halver` (fully proved), expander mixing lemma. See [`docs/halver-expander.md`](docs/halver-expander.md).
