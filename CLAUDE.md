...
Tanner's bound and supporting lemmas. Imports `Mixing.lean` and `Graph/Square.lean`:
...
Fin.lean → Graph/Regular.lean → Graph/Square.lean ─────→ ZigZag.lean
           ...
           Random.lean ────────────────────────────↗          ↑
           ZigZag/RVWInequality.lean ─→ ZigZag/RVWBound.lean ─↗  Halver.lean ─→ ExpanderToHalver.lean
